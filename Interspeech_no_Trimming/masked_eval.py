...
if __name__ == "__main__":
    ...
    target_dur_dict = {}
    full_proposed_min_durations_dict = {}
    ...
    for i in tqdm(range(num_samples)):
        ...
        # hyp_duration = [(np.sum(all_utt_segment_dur[i_segment])/2, iVOCAB[i_word]) for i_word, i_segment in valid_proposed_min_durations]
        # print(hyp_duration)
        ...
        full_proposed_min_durations_dict[key] = proposed_min_durations
    ...
    np.savez_compressed("outputs/target_dur_dict.npz", **target_dur_dict)
    np.savez_compressed("outputs/full_proposed_min_durations_dict.npz", **full_proposed_min_durations_dict)
    np.savez_compressed("outputs/full_all_utt_segment_dur_dict.npz", **full_all_utt_segment_dur_dict)
    np.savez_compressed("outputs/full_all_utt_seg_score_dict.npz", **full_all_utt_seg_score_dict)
