...
if __name__ == "__main__":
    ...
    # np.savez_compressed("output/target_dur_dict.npz", **target_dur_dict)
    np.savez_compressed("output/full_proposed_max_durations_dict.npz", **full_proposed_max_durations_dict)
    np.savez_compressed("output/full_all_utt_segment_dur_dict.npz", **full_all_utt_segment_dur_dict)
    np.savez_compressed("output/full_all_utt_seg_score_dict.npz", **full_all_utt_seg_score_dict)
